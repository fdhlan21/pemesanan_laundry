...
export default function PilihSendiri5({navigation}) {
  return (
    <View style={{flex:1,backgroundColor:'white'}}>
            ...
            <ScrollView style={{flex:1, padding:10}} >
                ...
                <View>
                    <Text style={{fontFamily:'Poppins-SemiBold', fontSize: 18}}>Total Rp 9.000</Text>
                </View>
            ...
            <View>
                ...
                <TouchableOpacity style={{padding:10, backgroundColor:colors.errormessage}}>
