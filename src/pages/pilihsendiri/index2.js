...
import { CelanaDalam, KoasKaki, LeftArrow, RincianPesananBantal, RincianPesananCelanaPanjang, RincianPesananJaket, RincianPesananKaos, SarungBantal, ThreeCircle } from '../../assets';
import colors from '../../utils/colors';


export default function PilihSendiri2({ navigation }) {
  ...
  return (
    ...
    <View style={{padding:10, }}>
        ...
        {/* CELANA PENDEK */}
        <View style={{padding:10,  borderRadius:5, borderBottomWidth:5, borderRightWidth:1, borderLeftWidth:1, borderColor: '#cccc',  width:143, height:136, backgroundColor:colors.primary}}>
        <View style={{flexDirection:'row'}}>
        <Image style={{width:50, height:50 }} source={ThreeCircle}/>
        <View style={{marginTop: 12, marginLeft: 20 }}>
        <TouchableOpacity style={{ backgroundColor: 'white', width: 23, height: 14, justifyContent: 'center', alignItems: 'center', marginRight: 10, borderTopRightRadius:5, borderTopLeftRadius:5,  }}>
        <Text style={{ color: colors.primary, fontSize: 12, fontWeight: 'bold' }}>+</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{ backgroundColor: colors.primary, width: 23, height: 14, justifyContent: 'center', alignItems: 'center',  borderBottomRightRadius:5, borderBottomLeftRadius:5, }}>
        <Text style={{ color: 'white', fontSize: 12, fontWeight: 'bold' }}>-</Text>
        </TouchableOpacity>
        </View>
        </View>
        <View style={{alignItems:'center', marginTop: 20}}>
        <Text style={{fontFamily:'Poppins-SemiBold', fontSize: 15, textAlign:'center', color:'white'}}>Celana Pendek</Text>
        <Text style={{fontFamily:'Poppins-Regular', fontSize: 12, textAlign:'center', color:'white'}}>Rp 2.000/pcs</Text>
        </View>
        </View>
        </View>
        ...
        <View>
            ...
            <View>
                <TouchableOpacity onPress={() => navigation.navigate("PilihSendiri3")} style={{padding:10, backgroundColor:colors.primary, borderTopRightRadius:10, borderTopLeftRadius:10}}>
                    <Text style={{color:'white', fontFamily:'Poppins-Bold', fontSize: 20, textAlign:'center'}}>Pesan Sekarang!</Text>
                </TouchableOpacity>
            </View>
    </View>
  );
