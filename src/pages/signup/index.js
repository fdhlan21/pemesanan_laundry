    ...
    <ScrollView>
        <View style={{
            ...
            <View style={{padding:10, marginTop:30}}>
                ...
                backgroundColor:'white', borderWidth:1, height:40, }} placeholder='Nama...' placeholderTextColor='gray' />
                ...
                <TouchableOpacity style={{padding:10, backgroundColor:colors.primary, borderRadius:10, marginTop:50}}>
                    <Text style={{textAlign:'center', fontFamily:'Poppins-SemiBold', fontSize:15, color:'white'}}>Sign Up</Text>
                </TouchableOpacity> 

                <TouchableOpacity onPress={() => navigation.navigate("loginPageScreen")} style={{padding:10}}>
